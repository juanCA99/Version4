	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-danger">
				<div class="panel-heading"> <center> ELIMINAR COTIZACIONES </center>
				</div>
				<div class="panel-body">
					<form method="post" action="?controller=Crud3&accion=Eliminar">
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
							<input type="text" name="Id_cotizacion_de_compra" class="form-control" placeholder="ingrese aqui el Id_cotizacion_de_compra a eliminar">
						</div>
						<hr>
