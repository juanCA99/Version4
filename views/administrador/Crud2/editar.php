...
<br>
<center><h1><font color="white">Editar PRODUCTOS</h1></center>

<div class="row">
		<div class="col-md-4 col-md-offset-4">
			<div class="panel panel-danger">
		
				<div class="panel-heading">EDITAR PRODUCTOS
				</div>
				<div class="panel-body">
					<form method="post" action="?controller=Administrador&accion=editar">
						...
						<div class="input-group">
							...
							<input type="text" name="id_electrodomestico" class="form-control" value=<?php echo $stmt['id_electrodomestico'];?> >
						</div>
						<br>
						<div class="input-group">
						...
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input type="text" name="tipo" class="form-control" value=<?php echo $stmt['tipo'] ?> >
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-send"></span></span>
							<input type="text" name="marca" class="form-control" value=<?php echo $stmt['marca'] ?> >
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input type="text" name="precio" class="form-control" value=<?php echo $stmt['precio'] ?> >
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
							<input type="text" name="ubicacion" class="form-control" value=<?php echo $stmt['ubicacion'] ?> >
						</div>
						<hr>
